...
export default function PlansScreen() {
  ...
  const accountType: AccountType = 'individual'; // from profile in real app
  ...
  const handleSelectPlan = async (planId: PlanId) => {
    try {
      ...
      if (plan.requiresBusinessInfo || (planId === 'pro' && accountType === 'professional')) {
        router.push({
          pathname: '/checkout/business-info',
        ...
        <View className="flex-row items-center justify-center gap-3 mb-6">
          ...
          >
            <View
              ...
              style={{ backgroundColor: billing === 'annual' ? '#6C5CE7' : '#374151', height: 26 }}
            />
            <View
              className="absolute top-1 w-4 h-4 bg-white rounded-full shadow-sm"
              style={{ left: billing === 'annual' ? 28 : 4 }}
            />
          </TouchableOpacity>
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  className={[
                    ...
                    plan.recommended ? 'bg-primary-500' : 'border border-gray-600',
                  ].join(' ')}
                >
                  {isLoading ? (
                    ...
                    <Text className={[
                      ...
                      plan.recommended ? 'text-white' : 'text-gray-300',
                    ].join(' ')}>
                      {t('plans.tryFree')}
                    </Text>
                  )}
